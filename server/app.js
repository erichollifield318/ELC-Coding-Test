 ...
 */
 ...
 const findSome = getValues => tag => tag.substr(0, getValues.filter.length) === getValues.filter;

const filterBy = getValues => elements => elements.tags.some(findSome(getValues));
